...
#define FDR_PACK_INFO     (0x00432B43)   // 定义当前坑的唯一标识 "C+C"
...
struct FDR_HEADER
{
	...
	unsigned long CRCStarting = FDR_CRC_STARTING;    // FDR_CRC_STARTING
	unsigned long CRCPolynomial = FDR_CRC_POLYNOMIAL;  // FDR_CRC_POLYNOMIAL
